...
function createDatasets() {
  ...
  let points2 = [
    vec3(-0.572, 0.342, 0), // t1
    vec3(0.02, 0.02, 0), // cmid
    vec3(0.372, 0.31, 0), // t2

    vec3(0.64,0.08, 0), // right
    vec3(0.14, -0.02, 0), // right2
    vec3(0.5, -0.11, 0), // right3

    vec3(0.23, -0.51, 0), // c2
    vec3(0.01, -0.27, 0), // t3
    vec3(-0.43, -0.65, 0), // c 1

    vec3(-0.5,-0.48, 0), // left3
    vec3(-0.14, 0.001, 0), // left2
    vec3(-0.54,0.18, 0), // left
  ];
  let segments2 = [
