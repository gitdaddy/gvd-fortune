// From https://github.com/ejpbruel/dcel
 ...
 */
Object.defineProperty(DCELHalfEdge.prototype, "origin", {
  configurable: true,
  enumerable: true,
  get: function () {
    return this._origin;
...
DCEL.prototype.splice = function (e1, e2) {
  ...
  if (e1._origin !== e2._origin) {
    this._killVertex(e2._origin, e1._origin);
    joinVertex = true;
  }
  var joinFace = false;
...
DCEL.prototype.connect = function (e1, e2) {
  ...
  enew._origin = e1._sym._origin;
  enew._left = e1._left;
  enewsym._origin = e2._origin;
...
DCEL.prototype.deleteEdge = function (edel) {
  ...
  if (edel._onext === edel) {
    this._killVertex(edel._origin, null);
  }
  else {
    var joinFace = false;
    ...
    edel._origin._edge = edel._onext;
  ...
  if (edelsym._onext === edelsym) {
    this._killVertex(edelsym._origin, null);
    this._killFace(edelsym._left, null);
  }
  else {
    edelsym._origin._edge = edelsym._onext;
